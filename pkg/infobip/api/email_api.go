...
func (r ApiGetEmailTemplatesRequest) Execute() (*EmailTemplatesResponse, *http.Response, error) {
...
func (a *EmailAPIService) GetEmailTemplatesExecute(r ApiGetEmailTemplatesRequest) (*EmailTemplatesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
